...
function ExploreCourses() {
  ...
  return (
    ...
    lg:flex-row items-center justify-center gap-4 px-[30px]'>
      ...
      flex flex-col items-start justify-center gap-1 md:px-[40px] px-[20px]'>
        ...
        <p className='text-[17px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
             Fugiat culpa iste autem corrupti ad laborum, fuga repudiandae temporibus alias.</p>

        <button className='px-[20px] py-[10px] border-2 bg-black border-white text-white 
        rounded-[10px] text-[18px] font-light flex gap-2 mt-[40px] cursor-pointer'
