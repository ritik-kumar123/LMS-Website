...
function MyEnrollledCourses() {
    const {userData} = useSelector(state =>state.user)
    const navigate = useNavigate()
  return (
    <div className='min-h-screen w-full px-4 py-9 bg-gray-50'>
        <FaArrowLeftLong className='absolute top-[3%] md:top-[6%] left-[5%]
                    ...
                    {userData?.enrolledCourses?.map((course,index)=>(
                        ...
                        border'>
                            ...
                            <div className='p-4'>
                                ...
                                font-light cursor-pointer mt-[10px] hover:bg-gray-600'
...
export default MyEnrollledCourses
